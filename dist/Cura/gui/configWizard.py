...
class FirstInfoPage(InfoPage):
	def __init__(self, parent, addNew):
		if addNew:
			...
			self.AddText(_("Welcome, and thanks for choosing Fracktal Works!"))
			self.AddSeperator()
		self.AddText(_("This wizard will help you in setting up Fracktory for your machine."))
		if not addNew:
			self.AddSeperator()
...
class OtherMachineInfoPage(InfoPage):
	def __init__(self, parent):
		super(OtherMachineInfoPage, self).__init__(parent, _("Fracktory Ready!"))
		self.AddText(_("Fracktory is now ready to be used!"))
