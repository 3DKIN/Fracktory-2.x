...
from Cura.gui import complaintWindow
...
class mainWindow(wx.Frame):
	def __init__(self):
		super(mainWindow, self).__init__(None, title='Fracktory ' + version.getVersion())
		...
		helpMenu = wx.Menu()
		i = helpMenu.Append(-1, _("Visit Website..."))
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('http://fracktal.in'), i)
	...
	def updateMachineMenu(self):
		...
		self.Bind(wx.EVT_MENU, self.OnMachineSettings, i)
		self.machineMenu.AppendSeparator()
		i = self.machineMenu.Append(-1, _("Register complaint for this machine"))
